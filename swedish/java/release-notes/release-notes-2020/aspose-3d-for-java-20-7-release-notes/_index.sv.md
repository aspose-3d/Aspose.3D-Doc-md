---
title: Aspose.3D for Java 20,7 Utgivning
type: docs
weight: 10
url: /sv/java/aspose-3d-for-java-20-7-release-notes/
---
{{% alert color="primary" %}} 

Denna sida innehåller release anteckningar för Aspose.3D for Java 20.7.
...
- Lagt till ny procedurmodelleringsklass**Com.aspose.3.SweptAreaSolid**
...
- Lagt till ny procedurmodelleringsklass**Com.aspose.3.RevolvedAreaSolid**
...
- Lagt till nya metoder i klass**Com.aspose. Threed.STLLoadOptions**
...
Några STL filer innehåller felaktiga normala, detta gör det möjligt att ignorera de ursprungliga normala data och beräkna de nya per-face data under importen.
...
- Lagt till ny profilformklass**Com.aspose.3. HollowCircleShape**
...
- Lagt till ny profilformklass**Com.aspose.3**
