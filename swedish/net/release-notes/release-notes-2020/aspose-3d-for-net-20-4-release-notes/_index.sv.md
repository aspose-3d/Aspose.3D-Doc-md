---
title: Aspose.3D for .NET 20,4 Utgivning
type: docs
weight: 40
url: /sv/net/aspose-3d-for-net-20-4-release-notes/
---
{{% alert color="primary" %}} 

Denna sida innehåller release anteckningar för Aspose.3D for .NET 20.4.
...
### **Lagt till medlemmar till Aspose.ThreeD.Utilities.Vertex klass**
{{< highlight "java" >}}
...
{{< /highlight >}}
### **Lagt till medlem till Aspose.ThreeD.Enheter.TriMesh klass**
...
{{< /highlight >}}
### **Tillagd klass Aspose.ThreeD.Render.WindowHandleName**
Det här används för att inkapsla det infödda fönstret för att skapa ett renderingsfönster.
### **Lagt till ledamot i klass Aspose.ThreeD.Render.RenderFactory**
...
{{< /highlight >}}
### **Föråldrad ledamot**
Den gamla CreateRenderWindow är markerad som föråldrad, för att anpassa den gamla koden till denna metod, rätta din gamla kod som följande kodutdrag:
...
{{< /highlight >}}
### **Lagt till medlemmar i klass Aspose.ThreeD.Utiliteter.IOUtills**
...
{{< /highlight >}}
### **Lagt till medlemmar i klass Aspose.ThreeD.Utiliteter.Vector3**
