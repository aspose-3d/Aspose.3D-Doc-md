---
title: Aspose.3D for .NET 19.2 Note di rilascio
type: docs
weight: 110
url: /it/net/aspose-3d-for-net-19-2-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le note di rilascio per[Aspose.3D for .NET 19.2](https://www.nuget.org/packages/Aspose.3D/19.2.0)
...
|:- |:- |:- |
|THREEDNET-472|Crea la geometria estrudendo le forme|Nuova funzione|
...
#### **Aggiunto il metodo FromControlPoints nella classe Aspose.ThreeD. Entità. Forma**
{{< highlight "java" >}}
...
{{< /highlight >}}
#### **Aggiunta nuova classe Aspose.ThreeD. Entità. LinearExtrusion:**
{{< highlight "java" >}}
