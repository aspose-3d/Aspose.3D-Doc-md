---
title: Aspose.3D for Java 20.7 Note di rilascio
type: docs
weight: 10
url: /it/java/aspose-3d-for-java-20-7-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le informazioni sulle note di rilascio per lo Aspose.3D for Java 20.7.
...
|:- |:- |:- |
|THREEDNET-679 |` ` Implemento IfcSweptDiskSolid algoritmo di modellazione procedurale compatibile|` `Nuova caratteristica|
|THREEDNET-678 |` `Aggiungere supporto per estrusione di area girevole.|` `Nuova caratteristica|
|THREEDNET-621 |` ` Supporto per forma cava|` `Nuova caratteristica|
...
- Aggiunta nuova classe di modellazione procedurale**Com. aspose.threed.SweptAreaSolid**
...
- Aggiunta nuova classe di modellazione procedurale**Com. aspose.threed.RevolvedAreaSolid**
...
- Aggiunti nuovi metodi in classe**Com. aspose.threed.STLLoadOptions**
...
Alcuni file STL contengono normali errate, questo consente di ignorare i dati normali originali e calcolare i nuovi dati per-face durante l'importazione.
...
- Aggiunta nuova classe di forma del profilo**Com. aspose.threed.HollowCircleShape**
...
- Aggiunta nuova classe di forma del profilo**Com. aspose.threed.HollowRectangleShape**
