---
title: Aspose.3D for Java 20.4 Note di rilascio
type: docs
weight: 40
url: /it/java/aspose-3d-for-java-20-4-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le informazioni sulle note di rilascio per lo Aspose.3D for Java 20.4.
...
### **Aggiunti membri a class com.aspose.threed.utilities.Vertex**
Leggi i dati del campo da un vertice.
...
{{< /highlight >}}
### **Membro aggiunto alla classe com.aspose.threed.entities.TriMesh**
...
{{< /highlight >}}
#### **Aggiunta classe com.aspose.threed.render.WindowHandle**
Viene utilizzato per incapsulare la maniglia finestra nativa per la creazione di una finestra di rendering.
### **Aggiunto membro a class com.aspose.threed. renderfactory**
{{< highlight "java" >}}
...
Il vecchio*CreateRenderWindow*È contrassegnato come Deprecato, per portare il vecchio codice su questo metodo, correggi il tuo vecchio codice come il seguente frammento di codice.
...
{{< /highlight >}}
### **Aggiunti membri a class com.aspose.threed.utilities.IOUtils**
...
{{< /highlight >}}
### **Aggiunti membri a class aspose.threed.utilities.vector3**
Queste sono utilità matematiche per il calcolo dell'angolo in radiante tra due vettori nello spazio 3D.
