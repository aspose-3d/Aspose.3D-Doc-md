---
title: Aspose.3D for Java 19.2 Note di rilascio
type: docs
weight: 110
url: /it/java/aspose-3d-for-java-19-2-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le note di rilascio per Aspose.3D for Java 19.2.
...
|**Riassunto**|**Categoria**|
|:- |:- |
|Crea la geometria estrudendo le forme|Nuova funzione|
...
**Metodo aggiunto FromControlPoints nella classe 'com.aspose.threed.Shape':**
...
**Aggiunta nuova classe "com.aspose.threed.LinearExtrusion":**
