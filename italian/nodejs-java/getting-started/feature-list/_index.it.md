...
type: docs
weight: 30
url: /it/nodejs-java/feature-list/
description: La funzione supportata da Aspose.3D for Node.js via Java
---
##  **Aspose.3D Caratteristiche**
###  **Caratteristiche generali**
- Scritto interamente in JavaScript e funziona in tutti gli ambienti supportati da JavaScript
- Supporta applicazioni GUI desktop, applicazioni Web e applicazioni console.
- API Riferimento in formato JavaDoc
- Microsoft Windows o sistema operativo basato su Linux.
