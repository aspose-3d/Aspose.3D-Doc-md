---
title: Öffentliche API Änderungen in Aspose.3D 17.01
type: docs
weight: 20
...
- [PLY Dateien importieren](#PublicAPIChangesinAspose.3D17.01-ImportingPLYFiles)
- [Fügt Aspose hinzu. ThreeD.Global Transform Class](#PublicAPIChangesinAspose.3D17.01-AddsAspose.ThreeD.GlobalTransformClass)
- [Fügt eine GlobalTransform-Eigenschaft zu Aspose hinzu. ThreeD.Node Class](#PublicAPIChangesinAspose.3D17.01-AddsaGlobalTransformpropertytoAspose.ThreeD.NodeClass)
- [Fügt Polygons-Eigenschaft zu Aspose hinzu. ThreeD.Entities.Mesh-Klasse](#PublicAPIChangesinAspose.3D17.01-AddsPolygonspropertytoAspose.ThreeD.Entities.MeshClass)
...
- [Entfernt CreateStream-Mitglied aus Aspose.ThreeD. Formate. IOConfig-Klasse](#PublicAPIChangesinAspose.3D17.01-RemovesCreateStreammemberfromAspose.ThreeD.Formats.IOConfigClass)

{{% alert color="primary" %}} 

Dieses Dokument beschreibt Änderungen an Aspose.3D API von Version 16.12.0 bis 17.1.0, die für Modul-/Anwendungs entwickler von Interesse sein könnten. Es enthält nicht nur neue und aktualisierte öffentliche Methoden, sondern auch eine Beschreibung aller Änderungen im Verhalten hinter den Kulissen in Aspose.3D.

{{% /alert %}} 
###  **Fügt PLY Format-Eintrag in der Aspose.ThreeD.FileFormat-Klasse hinzu**
Wir haben zu Lade zwecken einen PLY-Format eintrag hinzugefügt.
###  **PLY Dateien importieren**
Mit der aktuellen Version (17.01) oder höher können Entwickler PLY-Dateien importieren. Der PLY-Format eintrag wird zum Laden hinzugefügt.
...
{{< /highlight >}}
###  **Fügt Aspose hinzu. ThreeD.Global Transform Class**
...
###  **Fügt eine GlobalTransform-Eigenschaft zu Aspose hinzu. ThreeD.Node Class**
...
###  **Fügt Polygons-Eigenschaft zu Aspose hinzu. ThreeD.Entities.Mesh-Klasse**
...
{{< /highlight >}}
###  **Entfernt CreateStream-Mitglied aus Aspose.ThreeD. Formate. IOConfig-Klasse**
