...
type: docs
weight: 50
url: /de/net/aspose-3d-for-net-17-8-release-notes/
---
{{% alert color="primary" %}} 
...
1. [Rendern Sie eine Szene in die Cubemap mit sechs Gesichtern](/3d/de/net/render-a-scene-into-the-cubemap-with-six-faces/)
1. [Rendern Sie eine Panorama ansicht der Szene 3D](/3d/de/net/render-a-panorama-view-of-3d-scene/)
1. [Erstellen Sie einen Fisheye-Objektiv effekt in der Szene 3D und speichern Sie in einem Bild](/3d/de/net/create-a-fisheye-lens-effect-on-3d-scene-and-save-in-an-image/)
