...
description: C# .NET 3D Манипулирование файлами и преобразование API могут загружать и сохранять 3DS, 3MF, AMF, FBX, DFX, OBJ, PLY, STL, USD, U3D и другие форматы
tags: 3ds 3mf amf ase rvm 
---
##  **Поддерживаемые форматы файлов**
В следующей таблице указаны форматы файлов, которые Aspose.3D for .NET - C# 3D могут загружать и сохранять для обработки и преобразования файлов API.
...
|[RVM](https://docs.fileformat.com/3d/rvm/)|Модель системы управления проектным дизайном завода Авева|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
