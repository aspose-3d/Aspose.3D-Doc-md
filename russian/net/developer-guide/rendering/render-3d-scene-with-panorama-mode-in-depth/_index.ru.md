---
title: Render 3D Сцена с панорамой в глубине
type: docs
weight: 40
url: /ru/net/render-3d-scene-with-panorama-mode-in-depth/
description: Используя Aspose.3D for .NET API, разработчики могут визуализировать сцену 3D с режимом панорамы в глубину вместо цветов.
---
{{% alert color="primary" %}}

Используя[Aspose.3D for .NET 0761234881](https://products.aspose.com/3d/net/), Разработчики могут визуализировать сцену 3D с режимом панорамы в глубину вместо цветов.

{{% /alert %}}
## **Render 3D Сцена с панорамой в глубине**
...
Этот пример кода отображает сцену 3D с режимом Panorama в глубину.
