---
title: Рендеринг сцены 3D с режимом панорамы в глубине
type: docs
weight: 40
url: /ru/net/render-3d-scene-with-panorama-mode-in-depth/
description: Используя Aspose.3D for .NET API, разработчики могут рендерить сцену 3D с режимом панорамы в глубину вместо цветов.
---
{{% alert color="primary" %}}

Используя [Aspose.3D for .NET API](https://products.aspose.com/3d/net/), разработчики могут визуализировать сцену 3D с режимом панорамы в глубину вместо цветов.

{{% /alert %}}
##  **Рендеринг сцены 3D с режимом панорамы в глубине**
В этой статье мы создаем Camera и два Световых объекта для захвата сцены, класс ShaderSet помогает создать шейдер глубины.
###  **Образец программирования**
Этот пример кода отображает сцену 3D в режиме Панорама в глубину.
