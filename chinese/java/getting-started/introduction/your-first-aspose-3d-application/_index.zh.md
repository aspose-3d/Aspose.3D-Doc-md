...
type: docs
weight: 30
url: /zh/java/your-first-aspose-3d-application/
description: 使用 Aspose.3D for Java 以任何受支持的格式创建、编辑和保存您的第一个3d文件，以 Java 体验其简单性和强大功能。
...
1. 创建 [场景](https://reference.aspose.com/3d/java/com.aspose.threed/scene/) 类的实例。
1. 如果您有许可证，则为 [应用它](/3d/zh/java/licensing/)。
