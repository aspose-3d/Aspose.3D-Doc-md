...
type: docs
weight: 50
url: /zh/net/aspose-3d-for-net-17-8-release-notes/
---
{{% alert color="primary" %}} 
...
1. [用六个面将场景渲染到立方体图中](/3d/zh/net/render-a-scene-into-the-cubemap-with-six-faces/)
1. [渲染3D场景的全景视图](/3d/zh/net/render-a-panorama-view-of-3d-scene/)
1. [在3D场景上创建一个鱼眼镜头效果并保存在图像中](/3d/zh/net/create-a-fisheye-lens-effect-on-3d-scene-and-save-in-an-image/)
