...
1. Create an instance of the [Scene](https://apireference.aspose.com/3d/python-net/aspose.threed/scene) class that represents a 3D scene document.
1. Generate a 3D Scene document by calling the [Save](https://apireference.aspose.com/3d/python-net/aspose.threed/scene/methods/save) method of the Scene class object.
