...
Aspose.3D for Python via .NET offers to rotate objects in 3D space. There are three ways to define object’s rotation in 3D space, Euler angles, Quaternion and Custom Matrix, all of them are supported by the [Transform](https://reference.aspose.com/3d/python-net/aspose.threed/transform) class.
...
The [Mesh](https://reference.aspose.com/3d/python-net/aspose.threed.entities/mesh) class object is being used in the code. We can [create a Mesh class object as narrated there](/3d/net/create-3d-mesh-and-scene/).
