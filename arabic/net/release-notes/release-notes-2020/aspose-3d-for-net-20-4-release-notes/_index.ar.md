---
title: Aspose.3D for .NET 20.4 tes elease ootes
type: docs
weight: 40
url: /ar/net/aspose-3d-for-net-20-4-release-notes/
---
{{% alert color="primary" %}} 

Tصفحته تحتوي على معلومات ملاحظات الافراج عن Aspose.3D for .NET 20.4.
...
### **Added emالجمر إلى Aspose.ThreeD. tiliتيليتيز. Vertex الفئة**
{{< highlight "java" >}}
...
{{< /highlight >}}
### **Added ember إلى Aspose.ThreeD. nntities. TriMesh الفئة**
...
{{< /highlight >}}
### **Added Cلاس Aspose.ThreeD. ender أندر.**
يستخدم في تغليف مقبض النافذة الأصلي لإنشاء نافذة تقديم.
### **Added ember إلى الفئة Aspose.ThreeD.**
...
{{< /highlight >}}
### **Obsoleted ember إمبر**
يتم وضع علامة على أنه قديم CreateRenderWindow كما Obsoleted ، إلى ميناء التعليمات البرمجية القديمة إلى هذه الطريقة ، وإصلاح التعليمات البرمجية القديمة الخاصة بك مثل قنص الرمز التالي:
...
{{< /highlight >}}
### **أعضاء ded dded إلى الفئة Aspose.ThreeD. tilitulties. Vector3**
