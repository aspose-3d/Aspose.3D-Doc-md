---
title: Aspose.3D for Java 20.4 tes elease ootes
type: docs
weight: 40
url: /ar/java/aspose-3d-for-java-20-4-release-notes/
---
{{% alert color="primary" %}} 

Tصفحته تحتوي على معلومات ملاحظات الافراج عن Aspose.3D for Java 20.4.
...
|:- |:- |:- |
|THREEDNET-663 |` `Add Linux تقديم الدعم|` `New ميزة|
|THREEDNET-661 |` `Get البيانات مع العرف erertexDeclaration|` `Enhancement|
|THREEDNET-652 |` `Add التحكم في الحركة المدارية|` `Enhancement|
|THREEDNET-653 |` `Add خط الدعم بتنسيق A3DW.|` `Enhancement|
|THREEDNET-655 |` `Add تقديم الدعم من TriMesh|` `Enhancement|
|THREEDNET-656 |` ` كان تقديم ضوء غير صحيح في بائع الويب.|` `Bug|
## **Hangublic API و ackackward hangمتوافق مع hangمعلقة**
### **أعضاء Added إلى الفئة com.aspose.threed. المرافق. Vertex**
Read بيانات الحقل من قمة الرأس.
...
{{< /highlight >}}
### **عضو Added إلى الفئة كوم. أسبوس. ثريد. الكيانات.**
If الخاص بك ririMesh الحالات تأتي مع تخطيط الذاكرة غير مؤكد ، يمكنك استخدام هذه الطريقة لبناء مثيل جديد مع تخطيط الذاكرة المطلوبة بالضبط.
...
{{< /highlight >}}
### **عضو Added إلى الفئة كوم. أسبوس. ثريد. الكيانات.**
Wث هذه الطريقة ، يمكنك بسهولة إعادة بناء مثيل TriMesh من مجموعة بايت ، مثل الهجر.
...
{{< /highlight >}}
#### **Added فئة com.aspose.threed. تقديم.**
يستخدم في تغليف مقبض النافذة الأصلي لإنشاء نافذة تقديم.
### **عضو Added إلى الفئة com.aspose.threed. تقديم. renderfactory**
{{< highlight "java" >}}
...
Tانه قديم*CreateRenderWindow*يتم وضع علامة على أنها مجدولة ، إلى منفذ الرمز القديم إلى هذه الطريقة ، إصلاح التعليمات البرمجية القديمة الخاصة بك مثل مقتطف التعليمات البرمجية التالية.
...
{{< /highlight >}}
### **أعضاء Added إلى الفئة com.aspose.threed. المرافق.**
These هي طرق تمديد لكتابة Vector2/Vector3 إلى ritinaryWطقوس.
...
{{< /highlight >}}
### **Aأعضاء dded إلى الطبقة asform. threed. المرافق. vector3**
These هي المرافق الرياضية لحساب زاوية في راديان بين اثنين من ناقلات في مساحة 3D.
