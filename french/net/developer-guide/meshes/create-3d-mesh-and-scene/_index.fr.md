...
- [Créer des polygones avec PolygonBuilder Classe](/3d/fr/net/create-3d-mesh-and-scene/)
...
Les points de contrôle de toutes les géométries dans Aspose.3D utilisent des coordonnées homogènes, donc c'est `Vector4` au lieu de Vector3 dans l'exemple de code.
