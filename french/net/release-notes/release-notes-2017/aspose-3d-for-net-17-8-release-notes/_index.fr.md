...
type: docs
weight: 50
url: /fr/net/aspose-3d-for-net-17-8-release-notes/
---
{{% alert color="primary" %}} 
...
1. [Rendre une scène dans le cube avec six visages](/3d/fr/net/render-a-scene-into-the-cubemap-with-six-faces/)
1. [Rendre une vue panoramique de 3D scène](/3d/fr/net/render-a-panorama-view-of-3d-scene/)
1. [Créer un effet d'objectif Fisheye sur la scène 3D et enregistrer dans une image](/3d/fr/net/create-a-fisheye-lens-effect-on-3d-scene-and-save-in-an-image/)
